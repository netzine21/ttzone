    ...
    return `
      <section class="panel section-card operations-page">
        <div class="section-heading">
          <div><button type="button" class="btn btn-ghost" data-back-dashboard>대시보드로</button><p class="section-kicker">경기운영</p><h1>${operationTitle}</h1><p>게임 생성자만 조편성을 생성하고 수정할 수 있습니다.</p></div>
